...
/* Text format (used in texttype) */
	...
	#if !defined(VT_TEXT_FMT_UMD)
		#define	VT_TEXT_FMT_UMD								8
	#endif
#endif
...
#if defined(WIN32)
	_DllMode(short) VT_PLAYTTS_ENG(HWND hcaller, UINT umsg, char *text_buff, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
...
_DllMode(short) VT_TextToFile_ENG(int fmt, char *tts_text, char *filename, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);
...
_DllMode(int) VT_TextToBuffer_ENG(int fmt, char *tts_text, char *output_buff, int *output_len, int flag, int nThreadID, int nSpeakerID, int pitch, int speed, int volume, int pause, int dictidx, int texttype);



/*===========================================================================*/
/* CONFIGURE API */
_DllMode(void) VT_SetPitchSpeedVolumePause_ENG(int pitch, int speed, int volume, int pause, int nSpeakerID);
